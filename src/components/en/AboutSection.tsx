      ...
      <div className="flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="space-y-4 text-lg text-muted leading-relaxed">
            <p>
              I am a Fulbright research fellow based in La Plata, Argentina, where I am investigating how AI, open data, and cloud-native geospatial computing can help under-resourced cities better manage climate risks. I have a master&apos;s degree in city planning from the University of Pennsylvania&apos;s{" "}
              ...
              </a>, where I focused on environmental planning and geospatial data science.
            </p>
            <p>
              Previously, I worked as a research assistant for{" "}
              <a href="https://www.design.upenn.edu/people/allison-lassiter" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-foreground underline transition-colors duration-200 hover:scale-105">
                Professor Allison Lassiter
              </a>. We built a clustering model to identify vulnerable U.S. public drinking water systems, and worked on a multi-agent system simulation of how saltwater intrusion might affect coastal drinking water supply networks. With{" "}
              <a href="https://www.design.upenn.edu/people/matthijs-bouw" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-foreground underline transition-colors duration-200 hover:scale-105">
                Professor Matthijs Bouw
              </a>, I developed flooding and heat hazard models for a{" "}
              ...
              that will help urban planners in the Global South mitigate conflicts between urban expansion and climate threats and biodiversity loss.
            </p>
            <p>
              I was the founder and tech lead of{" "}
              <a href="https://www.cleanandgreenphilly.org/" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-foreground underline transition-colors duration-200 hover:scale-105">
                Clean & Green Philly
              </a>, an open source, nonprofit tech platform that promotes data-driven interventions in vacant properties to improve quality of life in Philadelphia.
            </p>
            <p>
              I&apos;m interested in using data and tech to foster civic engagement and build more resilient, inclusive cities. I believe in open source tech and community-driven work.
            </p>
          </div>
